...
# Some peace and quiet! Logging level 1 doesn't show INFO (0) logs. WARNING (1) and ERROR (2) are still shown
...
def run():
    ...
    correct_label = tf.placeholder(tf.bool, shape=(None, image_shape[0], image_shape[1], num_classes))
